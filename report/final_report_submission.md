...
![Figure 1: Distribution of daily returns](../stock-signal-capstone/figures/eda_returns_distribution.png)
*Figure 1: Distribution of daily returns across the liquid universe.*

![Figure 2: Momentum quintile test](../stock-signal-capstone/figures/momentum_quintiles.png)
...
![Figure 3: Model comparison](../stock-signal-capstone/figures/model_comparison.png)
*Figure 3: Model comparison by test-period ROC-AUC. Both models exceed the random baseline of 0.50.*

![Figure 4: Backtest cumulative returns](../stock-signal-capstone/figures/backtest_cumulative_returns.png)
...
![Figure 5: Feature importance](../stock-signal-capstone/figures/feature_importance.png)
